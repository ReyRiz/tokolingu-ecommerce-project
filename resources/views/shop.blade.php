        ...
        <div class="accordion" id="price-filters">
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="5000"
                data-slider-max="1000000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="Rp." />
              <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                  <span class="text-secondary">Min Price: </span>
                  <span class="price-range__min">Rp.5000</span>
                </div>
                <div>
                ...
                <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                  ...
                  <div class="slide-split_media position-relative">
                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                      <img loading="lazy" src="{{ asset('uploads/slides') }}/{{ $slide->image }}" width="630" height="450"
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page size"
              id="pagesize" name="pagesize" style="margin-right: 30px;">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__review d-flex align-items-center">
                  ...
                  <span class="reviews-note text-lowercase text-secondary ms-1">Review Asal Jadi</span>
                </div>
                ...
                <form method="POST" action="{{route('wishlist.item.remove', ["rowId"=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId])}}">
                  @csrf
                  @method('DELETE')
                  <button class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist" style="color:orange;"

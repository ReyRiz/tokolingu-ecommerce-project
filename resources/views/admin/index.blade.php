                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>Rp{{number_format($dashboardDatas[0]->TotalAmount, 3, ',', '.')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>Rp{{number_format($dashboardDatas[0]->TotalOrderedAmount, 3, ',', '.')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>Rp{{number_format($dashboardDatas[0]->TotalDeliveredAmount, 3, ',', '.')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap gap40">
                    <div>
                        ...
                        <div class="flex items-center gap10">
                            <h4>Rp{{number_format($TotalAmount, 3, ',', '.')}}</h4>
                        </div>
                    </div>
                    <div>
                        <div class="mb-2">
                        ...
                        <div class="flex items-center gap10">
                            <h4>Rp{{number_format($TotalOrderedAmount, 3, ',', '.')}}</h4>
                        </div>
                    </div>
                    <div>
                        <div class="mb-2">
                        ...
                        <div class="flex items-center gap10">
                            <h4>Rp{{number_format($TotalDeliveredAmount, 3, ',', '.')}}</h4>
                        </div>
                    </div>
                    <div>
                        <div class="mb-2">
                        ...
                        <div class="flex items-center gap10">
                            <h4>Rp{{number_format($TotalCanceledAmount, 3, ',', '.')}}</h4>
                        </div>
                    </div>
                </div>

                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="pname">
                                <div class="image">
                                    <img src="{{asset('uploads/products/thumbnails')}}/{{$item->product->image}}" alt="{{$item->name}}" class="image">
                                </div>
                                <div class="name">
                                    <a href="{{route('shop.product.details', ['product_slug'=>$item->product->slug])}}" target="_blank"
                                        class="body-title-2">{{$item->name}}</a>
                                </div>
                            </td>
            ...
            <table class="table table-striped table-bordered table-transaction">
                <tbody>
                    <tr>
                        ...
                        <th>Tax</th>
                        <td>{{number_format($order->tax, 3, ',', '.')}}</td>
                        <th>Discount</th>

...
class AdminController extends Controller
{
    ...
    public function brand_update(Request $request)
    {
        ...
        $brand->save();
        return redirect()->route('admin.brands')->with('status', 'Brand has beend updated successfully');
    }
    ...
    public function category_store(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.categories')->with('status', 'Categories added successfully');
    }
    ...
    public function product_store(Request $request)
    {
        ...
        if($request->hasFile('images')){
            $allowedfileExtion = ['jpeg', 'png', 'jpg'];
    ...
    public function slide_store(Request $request)
    {
        ...
        $file_extension = $request->file('image')->extension();
        $file_name = Carbon::now()->timestamp . '.' . $file_extension;
        $this->GenerateSlideThumbnailIsImage($image, $file_name);
        $slide->image = $file_name;
        $slide->save();
        return redirect()->route('admin.slides')->with('status', 'Slide added successfully');
    }

    public function GenerateSlideThumbnailIsImage($image, $imageName)
    {
    ...
    public function slide_update(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status', 'Slide has beend updated successfully');
    }
